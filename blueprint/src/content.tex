...
Moreover, we see that Theorem~\ref{thm:abc} gives a power-saving when $\lambda\in (0.99,1.001)$. We emphasise that this power-saving represents a proof of concept of the methods; we expect that the exponent can be reduced with substantial computer assistance.
...
\begin{theorem}[\cite[Lemma 3]{h-b84}] \label{thm:HeathBrownGeometry}
...
\]
for $1\leq i\leq d$, and $a_i=b_i=c_i=0$ for $i>d$. Then it follows from~\eqref{eq:xiyizi_2} that
