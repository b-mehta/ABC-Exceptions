...
\begin{lemma}\label{lem:MixedDeterminantMethods}
...
\begin{proof}
  \proves{lem:MixedDeterminantMethods}
  \uses{lem:EisensteinCrit,thm:BombieriPilaforDet,thm:HeathBrownpadicDet,thm:HeathBrownQuadraticForms,thm:BombierSchmidtforThueEqs,lem:omegaUpperBound}
...
\begin{proof}
  ...
  \uses{lem:MixedDeterminantMethods}
...
the first part of Lemma~\ref{lem:MixedDeterminantMethods}. This gives
\[
B_d(\mathbf{c},\mathbf{X},\mathbf{Y},\mathbf{Z}) \ll
...
Applying the second part of Lemma~\ref{lem:MixedDeterminantMethods} now gives
\[
B_d(\mathbf{c},\mathbf{X},\mathbf{Y},\mathbf{Z}) \ll
...
\begin{proof}
\proves{prop:prop:TrivialBoundforSstar}
\uses{prop:TrivialBoundforS}
...
\end{lemma}
\begin{proof}
\uses{prop:prop:TrivialBoundforSstar}
\end{proof}
and
