...
The argument used to prove Proposition~\ref{prop:TrivialBound} readily yields
...
\section*{Proof outline} We now describe the main ideas behind the proof of Theorem~\ref{thm:ABCExceptions}. In terms of the counting function $S_{\alpha,\beta,\gamma}(X)$, our task is to show that whenever $\alpha,\beta,\gamma\in (0,1]$ satisfy $\alpha+\beta+\gamma\leq \lambda$, we have
$
...
\begin{theorem}\label{thm:BdExceptions}
...
\begin{proof}[Proof of Theorem \ref{thm:ABCExceptions}]
  \proves{thm:ABCExceptions}
  \uses{thm:BdExceptions,lem:StoSstar,lem:NlambdatoSabc}
  \end{proof}
...
Proposition~\ref{prop:DiophantineReduction} is based on the following factorisation of an integer as a product of powers.
...
\begin{proposition}[Determinant method bound]\label{prop:DeterminantMethod}
Let $d\geq 1$, and let
\[
X_1,\ldots, X_d, Y_1,\ldots, Y_d,Z_1,\ldots, Z_d\geq 1.
\]
...
\begin{proposition}[Thue bound]\label{prop:ThueEquations}
Let $d\geq 1$, and let
\[
X_1,\ldots, X_d, Y_1,\ldots, Y_d,Z_1,\ldots, Z_d\geq 1.
\]
...
\end{proposition}
\begin{proof}
  \proves{prop:FourierBound}
  \uses{prop:FourierAnalysis}
...
\end{proposition}
\begin{proof}
  \proves{prop:GeometryBound}
  \uses{prop:GeometryofNumbers}
...
\end{proposition}
\begin{proof}
  \proves{prop:ThueBound}
  \uses{prop:ThueEquations}
...
\end{theorem}
\begin{proof}
  \proves{thm:ABCExponentNu}
  \uses{prop:TrivialBound, prop:FourierBound, prop:GeometryBound, prop:ThueBound, prop:DeterminantBound}
\end{proof}


\begin{proof}[Proof of Theorem \ref{thm:BdExceptions}]
\proves{thm:BdExceptions}
\uses{thm:ABCExponentNu, prop:DiophantineReduction, def:nu, def:BdDiophantineCount}
\end{proof}
