...
\begin{proposition}[Thue bound]\label{prop:ThueBound}
  \uses{def:aibici,def:nu,lem:Trivialaibici}
  \begin{align*}
...
\uses{prop:FourierBound, prop:GeometryBound, prop:ThueBound, prop:DeterminantBound, lem:aibiciconstraints, lem:Trivialaibici, lem:Case1, def:nu, lem:Case2}
  $\nu \le 0.66$.
\end{theorem}
\begin{proof}
