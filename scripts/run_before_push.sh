...
# Ensure the script is in the outermost 'ABC-Exceptions' folder
echo "Checking if you are in the correct directory..."
if [ ! -f lakefile.toml ]; then
  echo "❌ Error: This doesn't appear to be the outermost 'ABC-Exceptions' directory.
...
if ! lake build ABCExceptions; then
