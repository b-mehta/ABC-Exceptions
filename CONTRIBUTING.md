# Contributing to the ABC-Exceptions Project

Thank you for your interest in contributing to the ABC-Exceptions Project!
This guide provides detailed instructions on how to effectively and efficiently contribute to the project.

## Project Coordination

The project is managed using a [GitHub project dashboard](https://github.com/users/b-mehta/projects/1), which tracks tasks through various stages, from assignment to completion.
